...
{    
	...
	public class FTPFile
	{
        ...
        {
            this.lastModifiedTime = this.lastModifiedTime - difference;
        }
		...
		{
			StringBuilder buf = new StringBuilder(this.rawRep);
			buf.Append("[").Append("Name=").Append(this.fileName).Append(",").Append("Size=").
                Append(this.fileSize).Append(",").Append("Permissions=").Append(this.filePermissions).
                Append(",").Append("Owner=").Append(this.fileOwner).Append(",").
                Append("Group=").Append(this.userGroup).Append(",").Append("Is link=").Append(this.isLink).
                Append(",").Append("Link count=").Append(this.linkNum).Append(",").
                Append("Is dir=").Append(this.isDir).Append(",").
                Append("Linked name=").Append(this.linkedFileName).Append(",").
                Append("Permissions=").Append(this.filePermissions).Append(",").
                Append("Last modified=").Append(this.lastModifiedTime.ToString(format, CultureInfo.CurrentCulture.DateTimeFormat)).
                Append("]");
			return buf.ToString();
		}
    }
