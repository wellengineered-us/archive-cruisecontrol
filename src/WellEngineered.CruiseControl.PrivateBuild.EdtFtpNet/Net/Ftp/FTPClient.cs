...
namespace WellEngineered.CruiseControl.PrivateBuild.EdtFtpNet.Net.Ftp
{
    ...
    public class PortRange 
    {
        ...
        public bool UseOSAssignment
        {
            get
            {
                return this.low == LOW_PORT && this.high == DEFAULT_HIGH_PORT;
            }
            set
            {
                this.LowPort = LOW_PORT;
                this.HighPort = DEFAULT_HIGH_PORT;
            }
        }
        ...
        internal void ValidateRange()
        {
            if (this.low >= this.high)
                throw new FTPException("Low port (" + this.low + ") must be smaller than high port (" + this.high + ")");
        }
    ...
    public class FTPClient : IFileTransferClient
    {
        ...
        public bool Connected
        {
            get
            {
                return this.control == null ? false : this.control.Connected;
            }
        }
        ...
        {
            get { return this.fileFactory!=null ? this.fileFactory.TimeDifference : new TimeSpan(); }
            set { this.fileFactory.TimeDifference = value; }
        }
        ...
        {
            get { return this.fileFactory.TimeIncludesSeconds; }
        }
        ...
        public string LastFileTransferred
        {
            get
            {
                return this.lastFileTransferred;
            }
        }
		...
		public FTPTransferType TransferType
        {
            ...
            {                
                ...
                this.lastValidReply = this.control.ValidateReply(reply, "200", "250"); // 250 for Leitch media server
        ...
        private void InitBlock()
        {
            ...
            this.controlPort = FTPControlSocket.CONTROL_PORT;
        }
        ...
        internal virtual void Connect(string remoteHost, int controlPort, int timeout) 
        {
            if (controlPort < 0) 
            {
                this.log.Warn("Invalid control port supplied: " + controlPort + " Using default: " +
                    FTPControlSocket.CONTROL_PORT);
                controlPort = FTPControlSocket.CONTROL_PORT;
            }    
            this.controlPort = controlPort;
            if (this.log.DebugEnabled)
                this.log.Debug("Connecting to " + remoteHost + ":" + controlPort);
            this.Initialize(new FTPControlSocket(remoteHost, controlPort, timeout, this.controlEncoding, this.logTag));            
        }
        ...
        internal void Initialize(FTPControlSocket control)
        {
            ...
            this.control.CommandError += new FTPErrorEventHandler(this.CommandErrorControl);
            ...
            this.welcomeMessage = this.control.ValidateConnection().ReplyData;
        }
        ...
        internal void CheckConnection(bool shouldBeConnected)
        {
            ...
            else if (!shouldBeConnected && this.Connected)
		...
		/// <deprecated>
		/// Use the <see cref="Logger"/> class to 
        ...
        {            
            ...
            this.lastValidReply = this.control.ValidateReply(reply, "230", "232", "331");
            if (this.lastValidReply.ReplyCode.Equals("230") || this.lastValidReply.ReplyCode.Equals("232"))
                return ;
            else
            {
        ...
        {            
            ...
            try
            {
                this.lastValidReply = this.control.ValidateReply(reply, "230", "202", "332");
            }
        ...
        public virtual void Account(string accountInfo)
        {
            ...
            try
            {
                this.lastValidReply = this.control.ValidateReply(reply, "230", "202");
            }
            catch (FTPException ex)
            {
        ...
        public virtual void CancelResume()
        {
            ...
            {                
                this.log.Debug("REST failed which is ok (" + ex.Message + ")");
            }
            this.resumeMarker = 0;
            this.resume = false;
        }
        ...
        {
            this.lastFileTransferred = remoteFile;
            ...
            {
                this.log.Error("SystemException in Put(string,string,bool)", ex);
        ...
        public virtual long Put(Stream srcStream, string remoteFile, bool append)
        {
            ...
            try
            {
                if (this.transferType == FTPTransferType.ASCII)
                {
                    this.PutASCII(srcStream, remoteFile, append, false);
                }
                else
                {
                    this.PutBinary(srcStream, remoteFile, append, false);
                }
            }
            catch (SystemException ex)
            {
                this.log.Error("SystemException in Put(Stream,string,bool)", ex);
                this.ValidateTransferOnError();
                throw;
            }
            this.ValidateTransfer();
        ...
        {            
            ...
            {
                ex1 = ex;
                this.log.Warn("ReadReply failed", ex);
            }
            if (this.cancelTransfer)
            {
                ...
                throw new FTPTransferCancelledException("Transfer cancelled.", this.lastBytesTransferred);
            }
            else if (ex1 != null)
                throw ex1;

            this.lastValidReply = this.control.ValidateReply(reply, "225", "226", "250");
        }
        ...
        protected void ValidateTransferOnError()
        {
            ...
            {
                this.log.Error("Exception in ValidateTransferOnError())", e);
            }
            finally 
            {
                if (this.control != null)
        ...
        {   
            if (this.data != null)
            {
                ...
                {
                    this.log.Warn("Caught exception closing data socket", ex);
                }
                this.data = null;
            }
        }
        ...
        protected void CloseDataSocket(Stream stream)
        {
            if (stream != null)
            {
                ...
                {
                    this.log.Warn("Caught exception closing stream", ex);
                }
            }
        ...
        private DateTime SendServerWakeup(DateTime start)
        {
            ...
            if (elapsed >= this.noOperationInterval)
            {
            ...
            try
            {
                ...
                if (this.resume)
                {
                    ...
                    catch (FTPException ex)
                    {
                        this.resumeMarker = 0;
                        this.resume = false;
                        this.log.Warn("SIZE failed '" + remoteFile + "' - resume will not be used (" + ex.Message + ")");
                    }
                }
                ...
                if (this.resume)
                {
                    ...
                    catch (FTPException ex)
                    {
                        this.resumeMarker = 0;
                        this.resume = false;
                        this.log.Warn("REST failed - resume will not be used (" + ex.Message + ")");
                    }
                }
                ...
                // JScape returns 151
                this.lastValidReply = this.control.ValidateReply(reply, "125", "150", "151", "350");
            }
        ...
        private long PutASCII(Stream srcStream, string remoteFile, bool append, bool alwaysCloseStreams)
        {
            ...
            {
				input = 
                    (this.dataEncoding == null ? new StreamReader(srcStream) : new StreamReader(srcStream, this.dataEncoding));
                ...
                output =
                    (this.dataEncoding == null ? new StreamWriter(this.GetOutputStream()) : new StreamWriter(this.GetOutputStream(), this.dataEncoding));
                ...
                while ((line = input.ReadLine()) != null && !this.cancelTransfer)
                {
                    this.lastBytesTransferred += line.Length + 2;
                    ...
                    if (this.throttler != null)
                    {
                        this.throttler.ThrottleTransfer(this.lastBytesTransferred);
                    }

                    if (this.BytesTransferred != null && !this.cancelTransfer && monitorCount >= this.monitorInterval)
                    {
                        this.BytesTransferred(this, new BytesTransferredEventArgs(remoteFile, this.lastBytesTransferred, 0));
                        monitorCount = 0;
                    }
                    start = this.SendServerWakeup(start);
                }
            }
            catch (Exception ex)
            {
                this.log.Error("Caught exception " + ex.Message);
                storedEx = ex;              
            }
            finally
            {
                ...
                {
                    this.log.Warn("Caught exception flushing output-stream", ex);
                }
                this.CloseDataSocket(output);
            
                // if we did get an exception bail out now
                if (storedEx != null) {
                    this.log.Error("Caught exception", storedEx);
                    throw storedEx;
                }
        ...
        {    
            ...
            try
            {
                ...
                output = new BufferedStream(this.GetOutputStream());
                
                // if resuming, we skip over the unwanted bytes
                if (this.resume && this.resumeMarker > 0)
                {
                    input.Seek(this.resumeMarker, SeekOrigin.Current);
                }
                else
                    this.resumeMarker = 0;
                ...
                while ((count = input.Read(buf, 0, buf.Length)) > 0 && !this.cancelTransfer)
                {
                    output.Write(buf, 0, count);
                    this.lastBytesTransferred += count;
                    monitorCount += count;
                    ...
                    if (this.BytesTransferred != null && !this.cancelTransfer && monitorCount >= this.monitorInterval)
                    {
                        this.BytesTransferred(this, new BytesTransferredEventArgs(remoteFile, this.lastBytesTransferred, this.resumeMarker));
                        monitorCount = 0;
                    }
                    start = this.SendServerWakeup(start);
                }
            ...
            finally
            {
                ...
                this.log.Debug("Transferred " + this.lastBytesTransferred + " bytes to remote host");
            }
            return this.lastBytesTransferred;
        }
		...
		public virtual void Get(string localPath, string remoteFile)
        {
            ...
            {
                this.ValidateTransferOnError();
                this.log.Error("SystemException in Get(string,string)", ex);
                throw;
            }
            this.ValidateTransfer();
		...
		public virtual void Get(Stream destStream, string remoteFile)
        {
            ...
            {
                this.ValidateTransferOnError();
                this.log.Error("SystemException in Get(Stream,string)", ex);
                throw;
            }
            this.ValidateTransfer();
		...
		private void InitGet(string remoteFile)
        {
            ...
            try
            {
                ...
                this.lastValidReply = this.control.ValidateReply(reply, "125", "150");
            }
            catch (SystemException)
            {
                close = true;
		...
		private void GetASCII(string localPath, string remoteFile)
        {
            ...
            if (localFile.Exists)
            {
                ...
                output = (this.dataEncoding == null ? new StreamWriter(localPath) : new StreamWriter(localPath, false, this.dataEncoding));
            }
            if (output == null)
                output = (this.dataEncoding == null ? new StreamWriter(localPath) : 
                                                    new StreamWriter(localPath, false, this.dataEncoding));
            ...
            try
            {
                ...
                input =
                    (this.dataEncoding == null ? new StreamReader(this.GetInputStream()) : new StreamReader(this.GetInputStream(), this.dataEncoding));
                ...
                while ((line = this.ReadLine(input)) != null && !this.cancelTransfer)
                {
                    this.lastBytesTransferred += line.Length + 2;
                    monitorCount += line.Length + 2;
            ...
            finally
            {
                ...
                {
                    this.log.Warn("Caught exception closing output stream", ex);
                }
		...
		private void GetASCII(Stream destStream, string remoteFile)
        {
            ...
            StreamWriter output = 
                (this.dataEncoding == null ? new StreamWriter(destStream) : new StreamWriter(destStream, this.dataEncoding));
            StreamReader input = null;
            Exception storedEx = null;
            this.lastBytesTransferred = 0;
            try
		...
		private void GetBinary(string localPath, string remoteFile)
        {
            ...
            if (localFile.Exists)
            {
                ...
                if (this.resume)
                {
                    if (this.resumeMarker == 0)
                        this.resumeMarker = localFile.Length;
                    else
                        this.log.Debug("Resume marker already set explicitly: " + this.resumeMarker);
                }
                else
                    this.resumeMarker = 0;
            ...
            try
            {
                ...
                while ((count = this.ReadChunk(input, chunk, this.transferBufferSize)) > 0 && !this.cancelTransfer)
                {
            ...
            finally
            {
                ...
                // log bytes transferred
                this.log.Debug("Transferred " + this.lastBytesTransferred + " bytes from remote host");
            }
        }
		...
		public virtual byte[] Get(string remoteFile)
        {
            ...
            try
            {
                ...
                // do the retrieving
                long monitorCount = 0;
                byte[] chunk = new byte[this.transferBufferSize]; // read chunks into
                memStr = new MemoryStream(this.transferBufferSize); // temp swap buffer
            ...
            finally
            {
                ...
                if (this.TransferComplete != null)
                    this.TransferComplete(this, new EventArgs());
                if (this.TransferCompleteEx != null)
                    this.TransferCompleteEx(this, new TransferEventArgs(buffer, remoteFile, TransferDirection.UPLOAD, this.transferType));          
            }
            return buffer;
        }
        ...
        {            
            ...
            this.lastValidReply = this.control.ValidateReply(reply, "200", "202", "250", "502"); // 250 for leitch media server
        ...
        private string SetupDirDetails(string dirname)
        {
            ...
            if (!this.fileFactory.ParserSetExplicitly && this.fileFactory.System == null)
            {
                ...
                {
                    this.log.Warn("SYST command failed - setting Unix as default parser", ex);
                    this.fileFactory.System = FTPFileFactory.UNIX_STR;
                }
            }
            ...
            {
                this.log.Warn("Failed to find current directory: " + ex.Message);
            }
        ...
        public virtual FTPFile[] DirDetails(string dirname)
        {
            ...
            this.FixPaths(result,  path,  lastPart);
        ...
        public virtual FTPFile[] DirDetails(string dirname, FTPFileCallback dirListItemCallback)
        {
            ...
            state.files = result;
            state.fileFactory = this.fileFactory;
            state.fileCallback = dirListItemCallback;
            state.fileStrings = new ArrayList();
            this.Dir(dirname, true, new LineCallback(this.ProcessDirLine), state);

            FTPFile[] results = (FTPFile[])result.ToArray(typeof(FTPFile));

            this.FixPaths(results, path, lastPart);
        ...
        private void ProcessDirLine(string line, object state)
        {
            ...
            FTPFile file = this.fileFactory.PartialParse(line, processState.fileStrings);
            if (file != null)
            {
        ...
        {
            return this.Dir(dirname, full, null, null);
        }
        ...
        private string[] Dir(string dirname, bool full, LineCallback lineCallback, object state)
        {
            ...
            try
            {
                ...
                this.lastValidReply = this.control.ValidateReply(reply, "125", "226", "150", "450", "550");
                ...
                if (!replyCode.Equals("450") && !replyCode.Equals("550") && !replyCode.Equals("226"))
                {
                    ...
                    try
                    {
                        ...
                        {
                            lines = this.ReadASCIIListingData(dirname, lineCallback, state);
                        }
                        else
                        {
                            lines = this.ReadListingData(dirname, enc, lineCallback, state);
                        }

                        // check the control response
                        reply = this.control.ReadReply();
                        this.lastValidReply = this.control.ValidateReply(reply, "226", "250");
                    }
                    catch (SystemException ex)
                    {
                        this.ValidateTransferOnError();
                        this.log.Error("SystemException in directory listing", ex);
                        throw;
                    }
                    ...
                    if (!(lines.Count == 0))
                    {
                        this.log.Debug("Found " + lines.Count + " listing lines");
					...
					string replyText = this.lastValidReply.ReplyText.ToUpper();
                    if (!this.dirEmptyStrings.Matches(replyText)
                        && !this.transferCompleteStrings.Matches(replyText))
        ...
        private ArrayList ReadListingData(string dirname, Encoding enc, LineCallback lineCallback, object state) 
        {
            ...
            try
            {
                while ((line = this.ReadLine(input)) != null && !this.cancelTransfer)
                {
                    ...
                    if (this.transferNotifyListings && this.BytesTransferred != null && 
                        !this.cancelTransfer && monitorCount >= this.monitorInterval)
                    {
                        this.BytesTransferred(this, new BytesTransferredEventArgs(dirname, size, 0));
                        monitorCount = 0;
                    }
                    this.log.Debug("-->" + line);
                }
            ...
            {
                this.CloseDataSocket(input); // need to close here
            }
        }
        ...
        private ArrayList ReadASCIIListingData(string dirname, LineCallback lineCallback, object state) 
        {
            ...
            BufferedStream bstr = new BufferedStream(this.GetInputStream());
            ...
            try
            {
                while ((b = bstr.ReadByte()) != -1 && !this.cancelTransfer) 
                {
                    // end of line?
                    if (b == '\r' || b == '\n')
                    {
            ...
            {
                this.CloseDataSocket(bstr); // need to close here
            }
            return lines;   
        }
        ...
        {            
            ...
            this.lastValidReply = this.control.ValidateReply(reply, "200", "250");
        }
        ...
        {            
            ...
            // we cater for it ...
            this.lastValidReply = this.control.ValidateReply(reply, "200", "250", "257");
        }
        ...
        public virtual bool Exists(string remoteFile)
        {
            ...
            IPEndPoint endPoint = new IPEndPoint(this.control.LocalAddress, 0);
            sock.Bind(endPoint);
            try
            {
                this.control.SetDataPort((IPEndPoint)sock.LocalEndPoint);
            }
            finally
            {
                sock.Close();
        ...
        {            
            ...
            DateTime ts = 
                DateTime.ParseExact(this.lastValidReply.ReplyText, this.modtimeFormats, 
        ...
        public virtual void SetModTime(string remoteFile, DateTime modTime)
        {
            ...
            FTPReply reply = this.control.SendCommand("MFMT " + timeStr + " " + remoteFile);
            this.lastValidReply = this.control.ValidateReply(reply, "213");
        }
        ...
        {            
            ...
            string text = this.lastValidReply.ReplyText;
        ...
        {            
            ...
            this.lastValidReply = this.control.ValidateReply(reply, "211", "500", "502");
            if (this.lastValidReply.ReplyCode == "211")
            {
                string[] features = null;
                if (this.lastValidReply.ReplyData != null && this.lastValidReply.ReplyData.Length > 2)
                {
                    features = new string[this.lastValidReply.ReplyData.Length-2];
                    for (int i = 0; i < this.lastValidReply.ReplyData.Length-2; i++)
                        features[i] = this.lastValidReply.ReplyData[i+1].Trim();
                }
        ...
        {            
            ...
            this.lastValidReply = this.control.ValidateReply(reply, "200", "213", "215", "250"); // added 250 for leitch
            return this.lastValidReply.ReplyText;
        }
        ...
        public void NoOperation()
        {
            ...
            this.lastValidReply = this.control.ValidateReply(reply, "200", "250"); // added 250 for leitch
        }
        ...
        {            
            ...
            this.lastValidReply = this.control.ValidateReply(reply, "211", "214");
            return this.lastValidReply.ReplyText;
        }
        ...
        {            
            ...
            this.lastValidReply = this.control.ValidateReply(reply, "426", "226");
        }
        ...
        {            
            ...
            try
            {
                ...
                this.lastValidReply = this.control.ValidateReply(reply, "221", "226");
            }
            finally
            {
                this.CloseDataSocket();
