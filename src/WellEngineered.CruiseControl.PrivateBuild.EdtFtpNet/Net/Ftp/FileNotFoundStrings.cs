...
namespace WellEngineered.CruiseControl.PrivateBuild.EdtFtpNet.Net.Ftp
{
    ...
    public class FileNotFoundStrings : ServerStrings 
    {
        ...
        {
            this.Add(FILE_NOT_FOUND);
            this.Add(NO_SUCH_FILE);
            this.Add(CANNOT_FIND_THE_FILE);
            this.Add(FAILED_TO_OPEN_FILE);
            this.Add(COULD_NOT_GET_FILE);
            this.Add(DOES_NOT_EXIST);
            this.Add(NOT_REGULAR_FILE);            
            this.Add(CANNOT_FIND);
        }
