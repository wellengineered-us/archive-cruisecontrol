...
{    
	...
	public class FileAppender : Appender
	{
        ...
        {
            this.fileStream =
                new FileStream(this.fileName, FileMode.Append, FileAccess.Write, FileShare.ReadWrite);
            this.logger = StreamWriter.Synchronized(new StreamWriter(this.fileStream));
            this.closed = false;
        }
