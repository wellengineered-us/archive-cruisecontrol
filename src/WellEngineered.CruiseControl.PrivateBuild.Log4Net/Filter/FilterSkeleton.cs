...
namespace WellEngineered.CruiseControl.PrivateBuild.Log4Net.Filter
{
	/// <summary>
	...
	/// event filtering. Note that <see cref="Logger"/> and 
	/// <see cref="AppenderSkeleton"/>, the parent class of all standard
