...
namespace WellEngineered.CruiseControl.PrivateBuild.Log4Net.Util.TypeConverters
{
	/// <summary>
	...
	internal class TypeConverter : IConvertFrom 
	{
		...
		public object ConvertFrom(object source) 
		{
			...
			if (str != null)
			{
				...
				return SystemInfo.GetTypeFromString(this.GetType().GetTypeInfo().Assembly, str, true, true);
#else
