...
using WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout;
using WellEngineered.CruiseControl.PrivateBuild.Log4Net.Util.PatternStringConverters;
#if NETSTANDARD1_3
#endif

namespace WellEngineered.CruiseControl.PrivateBuild.Log4Net.Util
{
	/// <summary>
	...
	/// </para>
	/// <para>
	/// This class functions similarly to the <see cref="PatternLayout"/>
	/// in that it accepts a pattern and renders it to a string. Unlike the 
	/// <see cref="PatternLayout"/> however the <c>PatternString</c>
	...
	/// </para>
	/// <para>
	/// See the <see cref="PatternLayout"/> for details on the 
