...
using WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout.Pattern;
using WellEngineered.CruiseControl.PrivateBuild.Log4Net.Util;
using WellEngineered.CruiseControl.PrivateBuild.Log4Net.Util.PatternStringConverters;

using AppDomainPatternConverter=WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout.Pattern.AppDomainPatternConverter;
using DatePatternConverter=WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout.Pattern.DatePatternConverter;
using IdentityPatternConverter=WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout.Pattern.IdentityPatternConverter;
using PropertyPatternConverter=WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout.Pattern.PropertyPatternConverter;
using UserNamePatternConverter=WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout.Pattern.UserNamePatternConverter;
using UtcDatePatternConverter=WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout.Pattern.UtcDatePatternConverter;
...
namespace WellEngineered.CruiseControl.PrivateBuild.Log4Net.Layout
{
	...
	/// 			assumed (<see cref="Iso8601DateFormatter"/>).
	/// 			</para>
	/// 			<para>
	...
	/// 			<see cref="AbsoluteTimeDateFormatter"/>, 
	/// 			<see cref="DateTimeDateFormatter"/> and respectively 
	/// 			<see cref="Iso8601DateFormatter"/>. For example, 
