...
namespace WellEngineered.CruiseControl.PrivateBuild.Log4Net.Core
{
	...
	/// </para>
	/// <para>
	/// The levels that are recognized by log4net are set for each <see cref="ILoggerRepository"/>
	/// and each repository can have different levels defined. The levels are stored
	/// in the <see cref="ILoggerRepository.LevelMap"/> on the repository. Levels are
	/// looked up by name from the <see cref="ILoggerRepository.LevelMap"/>.
	/// </para>
	/// <para>
