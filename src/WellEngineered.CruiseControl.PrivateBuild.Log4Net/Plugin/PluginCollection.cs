...
namespace WellEngineered.CruiseControl.PrivateBuild.Log4Net.Plugin
{
	/// <summary>
...
#endif
	{
		...
		{
			this.m_array = new IPlugin[DEFAULT_CAPACITY];
		}
		...
		{
			PluginCollection newCol = new PluginCollection(this.m_count);
