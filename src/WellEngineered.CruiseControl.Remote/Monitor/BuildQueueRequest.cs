...
namespace WellEngineered.CruiseControl.Remote.Monitor
{
        ...
        : INotifyPropertyChanged, IEquatable<BuildQueueRequest>
    {
        ...
        public string Name
        {
            get { return this.InnerBuildQueueRequest.ProjectName; }
        }
        #endregion
        ...
        {
            get { return this.buildQueue.Server.FindProject(this.InnerBuildQueueRequest.ProjectName); }
        }
        #endregion
        ...
        {
            get { return this.InnerBuildQueueRequest.Activity; }
        }
        #endregion
        ...
        {
            get { return this.InnerBuildQueueRequest.RequestTime; }
        }
        #endregion
        #endregion
        ...
        public void Update(QueuedRequestSnapshot value)
        {
            ...
            if (this.snapshot.Activity != value.Activity) changes.Add("Activity");
            if (this.snapshot.RequestTime != value.RequestTime) changes.Add("RequestTime");
        ...
        {
            return this.Equals(obj as BuildQueueRequest);
        }
        ...
        public bool Equals(BuildQueueRequest obj)
        {
            ...
            return (obj.Project.Equals(this.Project) &&
                obj.RequestTime.Equals(this.RequestTime));
        }
        #endregion
        ...
        public override int GetHashCode()
        {
            return (this.BuildQueue == null ? 0 : this.BuildQueue.GetHashCode()) +
                ...
                (this.InnerBuildQueueRequest == null ? 0 : this.RequestTime.GetHashCode());
        }
        #endregion
        #endregion
