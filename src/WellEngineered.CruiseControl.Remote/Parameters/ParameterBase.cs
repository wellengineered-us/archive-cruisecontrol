...
namespace WellEngineered.CruiseControl.Remote.Parameters
{
    ...
    public abstract class ParameterBase
    {
        ...
        {
            get { return this.myDisplayName ?? this.myName; }
            set { this.myDisplayName = value; }
        }
        #endregion
        ...
        {
            get { return this.myDefault; }
            set { this.myDefault = value; }
        }
        #endregion
        ...
        public virtual object Convert(string value)
        {
            ...
            {
                actualValue = System.Convert.ChangeType(value, this.DataType);
            }
            return actualValue;
        }
        #endregion
        ...
        {
            string actualMessage = message.Replace("{name}", this.DisplayName);
