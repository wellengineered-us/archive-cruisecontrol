...
namespace WellEngineered.CruiseControl.Remote.Parameters
{
        ...
        : ParameterBase
    {
        ...
        {
            get { return this.myAllowedValues; }
            set
            {
                this.myAllowedValues = value;
        ...
        public override string[] AllowedValues
        {
            get
            {
                ...
                foreach (var value in this.myAllowedValues)
                {
        ...
        public override Exception[] Validate(string value)
        {
            ...
            else
            {
                ...
                foreach (var allowedValue in this.myAllowedValues)
                {
                ...
                if (!isAllowed) exceptions.Add(this.GenerateException("Value of '{name}' is not an allowed value"));
            }
        ...
        public override object Convert(string value)
        {
            ...
            foreach (var valueToCheck in this.myAllowedValues)
            {
        ...
        public override void GenerateClientDefault()
        {
            ...
            {
                using (var reader = File.OpenText(this.SourceFile))
                {
                    ...
                    this.myAllowedValues = values.ToArray();
                }
            }
        }
        #endregion
        ...
        {
            this.myClientDefault = this.DefaultValue;
            foreach (var value in this.myAllowedValues)
            {
                if (!string.IsNullOrEmpty(value.Name) && (this.DefaultValue == value.Value))
                {
                    this.myClientDefault = value.Name;
                    break;
                }
            }
        }
