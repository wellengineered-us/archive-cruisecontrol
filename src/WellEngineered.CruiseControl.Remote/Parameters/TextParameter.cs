...
namespace WellEngineered.CruiseControl.Remote.Parameters
{
        ...
        : ParameterBase
    {
        ...
        {
            get { return this.myMinLength; }
            set { this.myMinLength = value; }
        }
        ...
        {
            get { return this.myMaxLength; }
            set { this.myMaxLength = value; }
        }
        ...
        public override Exception[] Validate(string value)
        {
            ...
            {
                if (value.Length < this.myMinLength)
                {
                    exceptions.Add(
                        this.GenerateException("Value of '{name}' is less than the minimum length ({0})",
                                this.myMinLength));
                }
                if (value.Length > this.myMaxLength)
                {
                    exceptions.Add(
                        this.GenerateException("Value of '{name}' is more than the maximum length ({0})",
                                this.myMaxLength));
                }
            }
