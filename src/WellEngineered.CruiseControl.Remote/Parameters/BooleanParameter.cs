...
namespace WellEngineered.CruiseControl.Remote.Parameters
{
        ...
        : ParameterBase
    {
        ...
        public override string[] AllowedValues
        {
            ...
            {
                return new string[] {
                        string.IsNullOrEmpty(this.TrueValue.Name) ? this.TrueValue.Value : this.TrueValue.Name,
                        string.IsNullOrEmpty(this.FalseValue.Name) ? this.FalseValue.Value : this.FalseValue.Name
                    };
            }
        }
        #endregion
        ...
        public override object Convert(string value)
        {
            ...
            if ((testValue == this.TrueValue.Name) || (testValue == this.TrueValue.Value)) actualValue = this.TrueValue.Value;
            if ((testValue == this.FalseValue.Name) || (testValue == this.FalseValue.Value)) actualValue = this.FalseValue.Value;
            return actualValue;
        }
        #endregion
        #endregion
