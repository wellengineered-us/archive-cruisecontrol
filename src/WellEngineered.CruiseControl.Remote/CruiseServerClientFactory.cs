...
namespace WellEngineered.CruiseControl.Remote
{
        ...
        : ICruiseServerClientFactory
    {
        ...
        public CruiseServerClientFactory()
        {
            ...
            this.InitialiseDefaultTcpClient();
            this.InitialiseDefaultHttpClient();
            this.UseClientCaching = true;
        }
        #endregion
        ...
        {
            var client = this.GenerateClient(address, new ClientStartUpSettings());
            return client;
        }
        ...
        {
            var client = this.GenerateClient(address, targetServer, new ClientStartUpSettings());
            return client;
        }
        ...
        public CruiseServerClientBase GenerateClient(string address, ClientStartUpSettings settings)
        {
            ...
            if (this.initialisers.ContainsKey(transport))
            {
                if (this.UseClientCaching && this.clients.ContainsKey(address))
                {
                    return this.clients[address];
                }
                else
                {
                    var client = this.initialisers[transport](address, settings);
                    if (this.UseClientCaching) this.clients.Add(address, client);
                    return client;
                }
            }
            else
        ...
        {
            var client = this.GenerateClient(address, settings);
        ...
        {
            var client = this.GenerateHttpClient(address, new ClientStartUpSettings());
            return client;
        }
        ...
        {
            var client = this.GenerateHttpClient(address, targetServer, new ClientStartUpSettings());
            return client;
        }
        ...
        {
            var client = this.clients.ContainsKey(address) ?
        ...
        {
            var client = this.GenerateHttpClient(address, settings);
            client.TargetServer = targetServer;
            return client;
        }
        #endregion
        ...
        {
            var client = this.GenerateRemotingClient(address, new ClientStartUpSettings());
            return client;
        }
        ...
        {
            var client = this.GenerateRemotingClient(address, targetServer, new ClientStartUpSettings());
            return client;
        }
        ...
        {
            var client = this.GenerateRemotingClient(address, settings);
            client.TargetServer = targetServer;
            return client;
        }
        #endregion
        ...
        {
            this.initialisers["http"] = (address, settings) =>
            {
                if (settings.BackwardsCompatable)
                {
        ...
        {
            this.initialisers["tcp"] = (address, settings) =>
            {
                if (settings.BackwardsCompatable)
                {
        ...
        {
            this.initialisers[transport.ToLower()] = initialiser;
        }
        #endregion
