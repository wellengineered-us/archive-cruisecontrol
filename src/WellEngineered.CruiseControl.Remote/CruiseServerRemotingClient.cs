        ...
        : CruiseServerClientBase
    {
        ...
        public override string TargetServer
        {
            get
            {
                ...
                {
                    var targetUri = new Uri(this.serverUri);
        ...
        {
            var response = this.manager.GetProjectStatus();
            return response;
        }
        #endregion
        ...
        {
            this.manager.ForceBuild(projectName, this.userName);
        }
        ...
        {
            this.manager.AbortBuild(projectName, this.userName);
        }
        #endregion
        ...
        {
            this.manager.Request(projectName, integrationRequest);
        }
        #endregion
        ...
        {
            this.manager.SendMessage(projectName, message);
        }
        #endregion
        ...
        {
            this.manager.WaitForExit(projectName);
        }
        #endregion
        ...
        {
            this.manager.CancelPendingRequest(projectName);
        }
        #endregion
        ...
        {
            var response = this.manager.GetCruiseServerSnapshot();
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetLatestBuildName(projectName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetBuildNames(projectName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetMostRecentBuildNames(projectName, buildCount);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetLog(projectName, buildName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetServerLog();
            return response;
        }
        ...
        {
            var response = this.manager.GetServerLog(projectName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetServerVersion();
            return response;
        }
        #endregion
        ...
        {
            this.manager.AddProject(serializedProject);
        }
        #endregion
        ...
        {
            this.manager.DeleteProject(projectName, purgeWorkingDirectory, purgeArtifactDirectory, purgeSourceControlEnvironment);
        }
        #endregion
        ...
        {
            var response = this.manager.GetProject(projectName);
            return response;
        }
        #endregion
        ...
        {
            this.manager.UpdateProject(projectName, serializedProject);
        }
        #endregion
        ...
        {
            var response = this.manager.GetExternalLinks(projectName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetArtifactDirectory(projectName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetStatisticsDocument(projectName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetModificationHistoryDocument(projectName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.GetRSSFeed(projectName);
            return response;
        }
        #endregion
        ...
        {
            var response = this.manager.RetrieveFileTransfer(projectName, fileName);
            return response;
        }
        #endregion
        #endregion
