...
namespace WellEngineered.CruiseControl.Remote
{
        ...
        : XmlMemberSerialiser
    {
        ...
        public override object Read(XmlNode node, NetReflectorTypeTable table)
        {
            ...
            {
                var value = this.ReadValue(node as XmlElement);
                return value;
            }
        }
        ...
        public override void Write(XmlWriter writer, object target)
        {
            if (this.isList)
            {
                ...
                if (list != null)
                {
                    ...
                    {
                        this.WriteValue(writer, value, "value");
                    }
            ...
            else
            {
                ...
                if (value != null)
                {
                    this.WriteValue(writer, value, base.Attribute.Name);
                }
            }
        }
        #endregion
            ...
            if (node != null)
            {
                ...
                if (subNodes != null)
                {
                    foreach (XmlElement valueElement in subNodes)
                    {
                        ...
                        {
                            var newValue = this.ReadValue(valueElement);
