...
namespace WellEngineered.CruiseControl.Remote
{
    ...
    public class ItemStatus
    {
        ...
        {
            get { return this.timeOfEstimatedCompletion; }
            set { this.timeOfEstimatedCompletion = value; }
        }
        #endregion
        ...
        public override bool Equals(object obj)
        {
            ...
            if (dummy != null)
            {
                bool areEqual = this.identifier.Equals((dummy).identifier);
                return areEqual;
            }
            else
            {
