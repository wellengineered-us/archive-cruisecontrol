...
namespace WellEngineered.CruiseControl.Remote
{
	...
	public class ProjectStatus
	{
        ...
        {
            get { return this.currentBuildStage; }
            set { this.currentBuildStage = value; }
        }
        ...
        {
            get { return this.showForceBuildButton; }
            set { this.showForceBuildButton = value; }
        }
        ...
        {
            get { return this.showStartStopButton; }
            set { this.showStartStopButton = value; }
        }
		...
		{
			get { return this.lastBuildDate.DateTime; }
            set { this.lastBuildDate = new SerializableDateTime(value); }
		}
		...
		{
			get { return this.lastBuildLabel; }
            set { this.lastBuildLabel = value; }
		}
		...
		{
			get { return this.lastSuccessfulBuildLabel; }
            set { this.lastSuccessfulBuildLabel = value; }
		}
		...
		{
			get { return this.nextBuildTime.DateTime; }
            set { this.nextBuildTime = new SerializableDateTime(value); }
		}
        ...
        {
            get { return this.messages ?? new Message[0]; }
		...
		public string CurrentMessage
		{
			get
			{
				if (this.Messages.Length > 0) return this.Messages[this.Messages.Length-1].ToString();
				return string.Empty;
			}
		}
	}
