...
namespace WellEngineered.CruiseControl.PrivateBuild.SharpZipLib.Checksum
{
	/// <summary>
	...
	public sealed class BZip2Crc : IChecksum
	{
		...
		{
			this.checkValue = unchecked(crcTable[(byte)(((this.checkValue >> 24) & 0xFF) ^ bval)] ^ (this.checkValue << 8));
		}
