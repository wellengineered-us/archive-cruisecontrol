...
using WellEngineered.CruiseControl.PrivateBuild.SharpZipLib.GZip;

namespace WellEngineered.CruiseControl.PrivateBuild.SharpZipLib.Zip.Compression.Streams
{
	/// <summary>
