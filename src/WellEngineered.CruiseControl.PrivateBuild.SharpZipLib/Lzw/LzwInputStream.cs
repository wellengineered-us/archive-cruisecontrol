...
namespace WellEngineered.CruiseControl.PrivateBuild.SharpZipLib.Lzw
{
	/// <summary>
	...
	public class LzwInputStream : Stream
	{
		...
		private void ParseHeader()
		{
			...
			this.blockMode = (hdr[2] & LzwConstants.BLOCK_MODE_MASK) > 0;
			this.maxBits = hdr[2] & LzwConstants.BIT_MASK;

			if (this.maxBits > LzwConstants.MAX_BITS) {
				throw new LzwException("Stream compressed with " + this.maxBits +
			...
			this.nBits = LzwConstants.INIT_BITS;
