...
namespace WellEngineered.CruiseControl.WebDashboard.Dashboard.GenericPlugins
{
        ...
        : ProjectConfigurableBuildPlugin
    {
        ...
        public override INamedAction[] NamedActions
        {
            get
            {
                HtmlReportAction buildAction = (HtmlReportAction)this.actionInstantiator.InstantiateAction(typeof(HtmlReportAction));
                buildAction.HtmlFileName = this.HtmlFileName;
                return new INamedAction[] { new ImmutableNamedAction(this.ActionName, buildAction) };
            }
        }
        #endregion
        #endregion
