...
namespace WellEngineered.CruiseControl.WebDashboard.Resources
{
	/// <summary>
    ...
    public class Translations
    {
        ...
        {
            var context = __Fixup.GetCurrentHttpContext();
            try
            {
                ...
                if (string.IsNullOrEmpty(systemLanguage))
                {
                    ...
                    {
                        foreach (var language in new string[]{}/*context.Request.UserLanguages*/)
                        {
                            try
                            {
        ...
        public static Translations RetrieveCurrent()
        {
            ...
            {
                if (context.Items.ContainsKey("translations"))
                {
