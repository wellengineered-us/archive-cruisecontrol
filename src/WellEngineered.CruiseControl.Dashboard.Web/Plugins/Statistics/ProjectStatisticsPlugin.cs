...
namespace WellEngineered.CruiseControl.WebDashboard.Plugins.Statistics
{
    ...
    public class ProjectStatisticsPlugin : ICruiseAction, IPlugin
    {
        ...
        public IResponse Execute(ICruiseRequest cruiseRequest)
        {
            ...
            string xslFile = this.pathProvider.GetFullPathFor(this.XslFileName);
            string statisticsDocument = this.farmService.GetStatisticsDocument(cruiseRequest.ProjectSpecifier, cruiseRequest.RetrieveSessionToken());
            Log.Debug(statisticsDocument);
            string htmlFragment;
            try
            {
                htmlFragment = this.transformer.Transform(statisticsDocument, xslFile, xsltArgs);
            }
