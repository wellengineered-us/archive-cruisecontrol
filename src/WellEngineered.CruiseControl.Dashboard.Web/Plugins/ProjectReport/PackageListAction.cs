...
namespace WellEngineered.CruiseControl.WebDashboard.Plugins.ProjectReport
{
        ...
        : ICruiseAction
    {
        ...
        public IResponse Execute(ICruiseRequest cruiseRequest)
        {
            ...
            var packages = this.farmService.RetrievePackageList(cruiseRequest.ProjectSpecifier, cruiseRequest.RetrieveSessionToken());
            ...
            foreach (var package in packages)
            {
                packageList.Add(
                    new PackageDisplay
                    {
                        ...
                        Size = this.FormatSize(package.Size),
                        FileName = package.FileName.Replace("\\", "\\\\")
                    });
            }
            velocityContext.Add("packages", packageList);
            return this.viewGenerator.GenerateView("PackageList.vm", velocityContext);
        }
        #endregion
        #endregion
