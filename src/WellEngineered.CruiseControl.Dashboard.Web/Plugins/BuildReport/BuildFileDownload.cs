...
namespace WellEngineered.CruiseControl.WebDashboard.Plugins.BuildReport
{
        ...
        : ICruiseAction
    {
        ...
        public IResponse Execute(ICruiseRequest cruiseRequest)
        {
            ...
            {
                var htmlData = this.LoadHtmlFile(cruiseRequest, fileName);
            ...
            else
            {
                ...
                var fileTransfer = this.farmService.RetrieveFileTransfer(cruiseRequest.BuildSpecifier, fileName, cruiseRequest.RetrieveSessionToken());
