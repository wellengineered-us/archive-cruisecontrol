...
namespace WellEngineered.CruiseControl.Core.Tasks
{
        ...
        : BaseExecutableTask
    {
        ...
        {
            result.BuildProgressInformation.SignalStartRunTask(!string.IsNullOrEmpty(this.Description) ? this.Description : "Running CodeItRight analysis");
            ...
            if (processResult.Succeeded)
            {
                ...
                result.AddTaskResult(
                    this.fileSystem.GenerateTaskResultFromFile(xmlFile, true));
            }
