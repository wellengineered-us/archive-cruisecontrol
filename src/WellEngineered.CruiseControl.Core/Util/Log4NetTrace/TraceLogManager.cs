...
namespace WellEngineered.CruiseControl.Core.Util.Log4NetTrace
{
	...
	public sealed class TraceLogManager
	{
        ...
        private static ITraceLog WrapLogger(PrivateBuild.Log4Net.Core.ILogger logger)
		{
        ...
        private static ITraceLog[] WrapLoggers(PrivateBuild.Log4Net.Core.ILogger[] loggers)
		{
		...
		/// <returns>The wrapper for the logger specified</returns>
		private static ILoggerWrapper WrapperCreationHandler(PrivateBuild.Log4Net.Core.ILogger logger)
		{
