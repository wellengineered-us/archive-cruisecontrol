...
namespace WellEngineered.CruiseControl.Core.Util
{
	...
	public class ProcessArgumentBuilder
	{
        ...
        public void AppendArgument(string format, string value)
		{
			...
			this.builder.AppendFormat(CultureInfo.CurrentCulture, format, value);
		}
		...
		{
			if (condition) this.AppendArgument(value);
		}
		...
		{
			if (condition) this.AppendArgument(format, argument);
		}
        ...
        public void AddArgument(string arg, string separator, string value)
		{
			...
			this.builder.Append(string.Format(System.Globalization.CultureInfo.CurrentCulture,"{0}{1}{2}", arg, separator, StringUtil.AutoDoubleQuoteString(value)));
		}
		...
		public void AddArgument(string value)
		{
			...
			this.builder.Append(StringUtil.AutoDoubleQuoteString(value));			
		}
