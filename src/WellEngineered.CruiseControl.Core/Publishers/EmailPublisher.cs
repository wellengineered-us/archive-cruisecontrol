...
namespace WellEngineered.CruiseControl.Core.Publishers
{
        ...
        : TaskBase, IConfigurationValidation
    {
        ...
        {
            get { return this.emailGateway; }
            set { this.emailGateway = value; }
        }
        ...
        {
            get { return this.EmailGateway.MailHost; }
            set { this.EmailGateway.MailHost = value; }
        }
        ...
        public int MailPort
        {
            get { return this.EmailGateway.MailPort; }
            set { this.EmailGateway.MailPort = value; }
        }
        ...
        {
            get { return this.EmailGateway.MailHostUsername; }
            set { this.EmailGateway.MailHostUsername = value; }
        }
        ...
        {
            get { return this.EmailGateway.MailHostPassword; }
            set { this.EmailGateway.MailHostPassword = value; }
        }
        ...
        public bool UseSSL
        {
            get { return this.EmailGateway.UseSSL; }
            set { this.EmailGateway.UseSSL = value; }
        }
        ...
        {
            get { return this.xslFiles; }
            set { this.xslFiles = value; }
        }
        ...
        public bool IncludeDetails
        {
            get
            {
                return this.messageBuilder is HtmlDetailsMessageBuilder;
            }
            set
            {
                if (value)
                {
                    this.messageBuilder = new HtmlDetailsMessageBuilder();
                }
                else
                {
                    this.messageBuilder = new HtmlLinkMessageBuilder(false);
                }
            }
        }
        ...
        {
            get { return this.modifierNotificationTypes; }
            set { this.modifierNotificationTypes = value; }
        }
        ...
        {
            get { return this.subjectSettings; }
            set { this.subjectSettings = value; }
        }
        ...
        protected override bool Execute(IIntegrationResult result)
        {
            ...
            result.BuildProgressInformation.SignalStartRunTask(!string.IsNullOrEmpty(this.Description) ? this.Description : "Emailing ...");

            EmailMessage emailMessage = new EmailMessage(result, this);
            string to = emailMessage.Recipients;
            string subject = emailMessage.Subject;
            string message = this.CreateMessage(result);
            if (IsRecipientSpecified(to))
            {
                ...
                this.SendMessage(this.fromAddress, to, this.replytoAddress, subject, message, result.WorkingDirectory);
            }
        ...
        public virtual void SendMessage(string from, string to, string replyto, string subject, string message, string workingFolder)
        {
            try
            {
                using (var actualMessage = GetMailMessage(from, to, replyto, subject, message, workingFolder, this.Attachments))
                {
                    this.emailGateway.Send(actualMessage);
                }
            }
            catch (Exception e)
            {
        ...
        public string CreateMessage(IIntegrationResult result)
        {
            ...
            try
            {
                this.messageBuilder.xslFiles = this.XslFiles;
                return this.messageBuilder.BuildMessage(result);
            }
            catch (Exception e)
            {
