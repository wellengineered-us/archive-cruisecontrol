...
namespace WellEngineered.CruiseControl.Core.Publishers
{
	...
	public class EmailUser
	{
		...
		public override bool Equals(Object obj)
		{
			...
			return (user.Name == this.Name && user.Address == this.Address && user.Group == this.Group);
		}
		...
		{
			return String.Concat(this.Name, this.Address, this.Group).GetHashCode();
		}
		...
		{
			return string.Format(System.Globalization.CultureInfo.CurrentCulture,"Email User: {0} {1} {2}", this.Name, this.Address, this.Group);
		}
	}
}