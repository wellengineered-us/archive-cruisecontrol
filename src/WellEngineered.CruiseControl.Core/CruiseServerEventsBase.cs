...
namespace WellEngineered.CruiseControl.Core
{
    ...
    public abstract class CruiseServerEventsBase
    {
        ...
        {
            bool isCanceled = false;
            if (this.ProjectStopping != null)
            {
                CancelProjectEventArgs args = new CancelProjectEventArgs(projectName);
                this.ProjectStopping(this, args);
                isCanceled = args.Cancel;
            }
            return isCanceled;
        }
        ...
        {
            if (this.ProjectStopped != null)
            {
                ProjectEventArgs args = new ProjectEventArgs(projectName);
                this.ProjectStopped(this, args);
            }
        }
        #endregion
        ...
        {
            bool isCanceled = false;
            if (this.AbortBuildReceived != null)
            {
                CancelProjectEventArgs<string> args = new CancelProjectEventArgs<string>(projectName, enforcerName);
                this.AbortBuildReceived(this, args);
                isCanceled = args.Cancel;
            }
            return isCanceled;
        }
        ...
        {
            if (this.AbortBuildProcessed != null)
            {
                ProjectEventArgs<string> args = new ProjectEventArgs<string>(projectName, enforcerName);
                this.AbortBuildProcessed(this, args);
            }
        }
        #endregion
