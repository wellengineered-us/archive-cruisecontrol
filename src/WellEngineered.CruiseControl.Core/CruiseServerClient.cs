...
namespace WellEngineered.CruiseControl.Core
{
        ...
        : MarshalByRefObject, ICruiseServerClient
    {
        ...
        public CruiseServerClient(ICruiseServer cruiseServer)
        {
            ...
            {
                this.channelSecurity = server.SecurityManager.Channel;
            }
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetProjectStatus(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.Start(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.Stop(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.ForceBuild(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.AbortBuild(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.CancelPendingRequest(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.SendMessage(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.WaitForExit(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetCruiseServerSnapshot(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetLatestBuildName(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetBuildNames(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetMostRecentBuildNames(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetLog(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetFinalBuildStatus(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetServerLog(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.AddProject(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.DeleteProject(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.UpdateProject(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetProject(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetExternalLinks(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetArtifactDirectory(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetStatisticsDocument(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetModificationHistoryDocument(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetRSSFeed(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetServerVersion(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.Login(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.Logout(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetSecurityConfiguration(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.ListUsers(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.DiagnoseSecurityPermissions(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.ReadAuditRecords(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.ListBuildParameters(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.ChangePassword(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.ResetPassword(request);
        }
        #endregion
        ...
        public virtual string ProcessMessage(string action, string message)
        {
            ...
            try
            {
                ...
                response = this.ExtractAndInvokeMessage(message, action, new RemotingChannelSecurityInformation());
            }
        ...
        {
            return this.cruiseServer.GetFreeDiskSpace(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.TakeStatusSnapshot(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.RetrievePackageList(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.RetrieveFileTransfer(request);
        }
        #endregion
        ...
        {
            return this.cruiseServer.GetLinkedSiteId(request);
        }
        #endregion
        ...
        public Response ProcessSecureRequest(ServerRequest request)
        {
            ...
            if (!this.connections.ContainsKey(request.SourceName)) throw new CruiseControlException("No secure connection for the source");
            var connection = this.connections[request.SourceName];
            ...
            // Find the action and message type, extract the message and invoke the method
            var response = this.ExtractAndInvokeMessage(data, encryptedRequest.Action,
        ...
        public Response InitialiseSecureConnection(LoginRequest request)
        {
            ...
            if (!this.connections.ContainsKey(request.SourceName))
            {
                this.connections.Add(request.SourceName, connection);
            }
            else
            {
                this.connections[request.SourceName] = connection;
            }
        ...
        public Response TerminateSecureConnection(ServerRequest request)
        {
            ...
            if (this.connections.ContainsKey(request.SourceName))
            {
                this.connections.Remove(request.SourceName);
            }
        ...
        private Type FindMessageType(string messageName)
        {
            ...
            if (this.messageTypes == null)
            {
                ...
                foreach (Type remotingType in remotingLibrary.GetExportedTypes())
                {
                    ...
                    {
                        this.messageTypes.Add(attribute.ElementName, remotingType);
                    }
                }
            }

            // Attempt to find the message within the message types
            if (this.messageTypes.ContainsKey(messageName))
            {
                messageType = this.messageTypes[messageName];
            }
        ...
        private object ConvertXmlToObject(Type messageType, string message)
        {
            ...
            if (!this.messageSerialisers.ContainsKey(messageType))
            {
                this.messageSerialisers[messageType] = new XmlSerializer(messageType);
            }

            // Perform the actual conversion
            using (StringReader reader = new StringReader(message))
            {
                messageObj = this.messageSerialisers[messageType].Deserialize(reader);
            }
            ...
            object channelInformation)
        {
            ...
            var messageType = this.FindMessageType(messageXml.DocumentElement.Name);
            if (messageType == null)
            {
                throw new CruiseControlException(
                    string.Format(
            ...
            var request = this.ConvertXmlToObject(messageType, message);
