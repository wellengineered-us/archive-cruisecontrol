...
{
    /// <summary>
    /// This supports C�dice Software's Plastic SCM source control system.
    /// </summary>
    ...
    public class PlasticSCM : ProcessSourceControl
    {
        ...
        public override Modification[] GetModifications(IIntegrationResult from, IIntegrationResult to)
        {
            ...
            Modification[] modifications = this.GetModifications(this.CreateQueryProcessInfo(from, to), from.StartTime, to.StartTime);
        ...
        public override void LabelSourceControl(IIntegrationResult result)
        {
            if (this.LabelOnSuccess && result.Succeeded)
            {
                ...
                this.Execute(this.CreateLabelProcessInfo(result));
        ...
        public override void GetSource(IIntegrationResult result)
        {
            ...
            {
                this.Execute(this.GoToBranchProcessInfo(result));
            }
        }
        ...
        public ProcessInfo GoToBranchProcessInfo(IIntegrationResult result)
        {
            ...
            builder.AppendArgument(string.Format(System.Globalization.CultureInfo.CurrentCulture, "stb {0}", this.Branch));
            if (!(this.Repository != null && this.Repository.Length == 0))
            {
                builder.AppendArgument(string.Format(System.Globalization.CultureInfo.CurrentCulture, "-repository={0}", this.Repository));
            }
        ...
        public ProcessInfo CreateQueryProcessInfo(IIntegrationResult from, IIntegrationResult to)
        {
            ...
            builder.AppendArgument(
                ...
                this.Branch, from.StartTime.ToString(DATEFORMAT, CultureInfo.InvariantCulture), to.StartTime.ToString(DATEFORMAT, CultureInfo.InvariantCulture)));
            if (!(this.Repository != null && this.Repository.Length == 0))
            {
                builder.AppendArgument(string.Format(System.Globalization.CultureInfo.CurrentCulture, "on repository '{0}'", this.Repository));
            }
            ...
            return this.NewProcessInfoWithArgs(from, builder.ToString());
        }
        ...
        {
            string labelName = this.LabelPrefix + result.Label;
        ...
        {
            return new ProcessInfo(this.Executable, args, result.BaseFromWorkingDirectory(this.WorkingDirectory));
        }
    }
}
