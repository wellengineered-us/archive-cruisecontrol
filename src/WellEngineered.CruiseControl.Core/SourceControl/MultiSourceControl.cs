...
namespace WellEngineered.CruiseControl.Core.SourceControl
{
        ...
        : SourceControlBase
	{
		...
		public ISourceControl[] SourceControls 
		{
			get 
			{
				if (this._sourceControls == null)
					this._sourceControls = new ISourceControl[0];
        ...
        public override Modification[] GetModifications(IIntegrationResult from, IIntegrationResult to)
		{
            ...
            if (fromSourceControlDataCount > 0 &&
                (fromSourceControlDataCount != this.SourceControls.Length ||
               ...
               )
            {
                ...
                for (int i = 0; i < this.SourceControls.Length; i++)
            ...
            foreach (ISourceControl sourceControl in this.SourceControls)
            {
                ...
                else if (this.RequireChangesFromAll)
                {
        ...
        public override void ApplyParameters(Dictionary<string, string> parameters, IEnumerable<ParameterBase> parameterDefinitions)
        {
            ...
            foreach (var child in this.SourceControls)
            {
