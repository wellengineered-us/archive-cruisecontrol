...
namespace WellEngineered.CruiseControl.Core
{
	...
	public abstract class ProjectBase: INotifyPropertyChanged
	{
		...
		{
			get { return this.configuredWorkingDirectory; }
			set { this.configuredWorkingDirectory = value; }
		}
		...
		{
			get { return this.configuredArtifactDirectory; }
			set { this.configuredArtifactDirectory = value; }
		}
		...
		{
			get { return this.externalLinks; }
			set { this.externalLinks = value; }
		}
        ...
        {
            get { return this.askForForceBuildReason; }
            set { this.askForForceBuildReason = value; }
        }
		...
		public string WorkingDirectory
		{
			get
			{
                if (string.IsNullOrEmpty(this.configuredWorkingDirectory))
				{
					return this.executionEnvironment.EnsurePathIsRooted(Path.Combine(this.Name, DefaultWorkingSubDirectory));
				}
				return new DirectoryInfo(this.configuredWorkingDirectory).FullName;
			}
		}
		...
		public string ArtifactDirectory
		{
			get
			{
                if (string.IsNullOrEmpty(this.configuredArtifactDirectory))
				{
					return this.executionEnvironment.EnsurePathIsRooted(Path.Combine(this.Name, DefaultArtifactSubDirectory));
				}
				return new DirectoryInfo(this.configuredArtifactDirectory).FullName;
			}
		}
