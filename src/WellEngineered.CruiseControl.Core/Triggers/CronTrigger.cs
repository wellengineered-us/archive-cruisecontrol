    ...
    public class CronTrigger : ITrigger
    {
        ...
        public void IntegrationCompleted()
        {
            if (this.triggered)
            {
                ...
                this.StartDate = this.dtProvider.Now;
        ...
        public DateTime NextBuild
        {
            get
            {
                ...
                {
                    this.schedule = NCrontab.CrontabSchedule.Parse(this.CronExpression);
                    this.SetNextIntegrationDateTime();
                }
        ...
        {
            this.nextBuild = this.schedule.GetNextOccurrence(this.StartDate, this.EndDate);
        }
