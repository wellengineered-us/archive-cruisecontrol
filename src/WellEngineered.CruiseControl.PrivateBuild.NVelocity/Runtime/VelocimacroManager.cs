...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime
{
    ...
    public class VelocimacroManager
    {
        ...
        public bool InlineReplacesGlobal
        {
            set
            {
                this.inlineReplacesGlobal = value;
            }
        ...
        */
        ...
        public bool AddVM(string vmName, INode macroBody, string[] argArray, string namespace_Renamed, bool canReplaceGlobalMacro)
        {
            ...
            me.FromLibrary = this.registerFromLib;
            ...
            */
            ...
            MacroEntry exist = (MacroEntry)this.globalNamespace[vmName];

            if (this.registerFromLib)
            {
                this.libraries.Add(namespace_Renamed, namespace_Renamed);
            }
            else
            {
                /*
                ...
                */
                ...
                isLib = this.libraries.Contains(namespace_Renamed);
            }

            if (!isLib && this.UsingNamespaces(namespace_Renamed))
            {
                /*
                ...
                */
                ...
                IDictionary local = this.GetNamespace(namespace_Renamed, true);
                local[vmName] = me;
            ...
            else
            {
                ...
                */
                ...
                this.globalNamespace[vmName] = me;
        ...
        {
            return (this.Get(vmName, namespace_Renamed, null));
        }
        ...
        {
            if (this.inlineReplacesGlobal && renderingTemplate != null)
            {
                /*
                ...
                */
                IDictionary local = this.GetNamespace(renderingTemplate, false);
                if (local != null)
                {
            ...
            {
                IDictionary local = this.GetNamespace(namespace_Renamed, false);
            ...
            */
            ...
            MacroEntry me2 = (MacroEntry)this.globalNamespace[vmName];
        ...
        public bool DumpNamespace(string namespace_Renamed)
        {
            lock (this)
            {
                ...
                {
                    object tempObject;
                    tempObject = this.namespaceHash[namespace_Renamed];
                    this.namespaceHash.Remove(namespace_Renamed);
        ...
        {
            IDictionary h = (IDictionary)this.namespaceHash[namespace_Renamed];

            if (h == null && addIfNew)
            {
                h = this.AddNamespace(namespace_Renamed);
            }
        ...
        private IDictionary AddNamespace(string namespace_Renamed)
        {
            ...
            object tempObject;
            tempObject = this.namespaceHash[namespace_Renamed];
            this.namespaceHash[namespace_Renamed] = h;
            if ((oh = tempObject) != null)
            {
                ...
                */
                this.namespaceHash[namespace_Renamed] = oh;
                /*
        ...
        private class MacroEntry
        {
            ...
            internal MacroEntry(string vmName, INode macro, string[] argArray, string sourceTemplate)
            {
                ...
                this.vp.ArgArray = this.argArray;
                this.vp.NodeTree = this.nodeTree;
            }
