...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Parser.Node
{
    ...
    public class BooleanPropertyExecutor : PropertyExecutor
    {
        ...
        /// <since> 1.5
        /// </since>
        public BooleanPropertyExecutor(Log.Log log, Introspector introspector, System.Type clazz, string property)
        ...
        protected internal override void Discover(System.Type clazz, string property)
        {
            try
            {
                ...
                if (this.Property != null && this.Property.Property.PropertyType.Equals(typeof(Boolean)))
                {
                    return;
                }
