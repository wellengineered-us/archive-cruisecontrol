...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Parser.Node
{
    ...
    public class MapSetExecutor : SetExecutor
    {
        ...
        public MapSetExecutor(Log.Log log, System.Type clazz, string property)
        {
            this.log = log;
        ...
        protected internal virtual void Discover(System.Type clazz)
        {
            if (!string.IsNullOrEmpty(this.property))
            {
                ...
                if (interfaces != null)
                {
                    try
                    {
                        this.Method = new MethodEntry(typeof(IDictionary).GetMethod("set_Item"), null);
                    }
                    /**
        ...
        {
            ((IDictionary)o)[this.property] = arg;
