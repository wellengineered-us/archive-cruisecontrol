...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Parser.Node
{
    ...
    public class ASTIdentifier : SimpleNode
    {
        ...
        public override object Init(IInternalContextAdapter context, object data)
        {
            ...
            this.identifier = this.FirstToken.Image;
        ...
        /// <seeaobjectNode.Execute(java.lang.Object, org.apache.velocity.context.InternalContextAdapter)">
        /// </seealso>
        public override object Execute(object o, IInternalContextAdapter context)
        {
                ...
                */
                ...
                else
                {
                    ...
                    */
                    ...
                    vg = this.rsvc.Uberspect.GetPropertyGet(o, this.identifier, this.uberInfo);
            ...
            */
            ...
            if (vg == null)
            {
                if (this.strictRef)
                {
                    throw new MethodInvocationException("Object '" + o.GetType().FullName + "' does not contain property '" + this.identifier + "'", null, this.identifier, this.uberInfo.TemplateName, this.uberInfo.Line, this.uberInfo.Column);
                }
                else
                {
                    return null;
            ...
            catch (System.Reflection.TargetInvocationException ite)
            {
                ...
                */
                ...
                if (t is System.Exception)
                {
                    try
                    {
                        return EventHandlerUtil.MethodException(this.rsvc, context, o.GetType(), vg.MethodName, (System.Exception)t);
                    }
                    /**
                    ...
                    */
                    ...
                    {
                        throw new MethodInvocationException("Invocation of method '" + vg.MethodName + "'" + " in  " + o.GetType() + " threw exception " + ite.GetBaseException().ToString(), ite.GetBaseException(), vg.MethodName, this.TemplateName, this.Line, this.Column);
                    }
                }
                else
                {
            ...
            */
            ...
            {
                string msg = "ASTIdentifier() : exception invoking method " + "for identifier '" + this.identifier + "' in " + o.GetType();
                this.log.Error(msg, e);
                throw new VelocityException(msg, e);
            }
        }
