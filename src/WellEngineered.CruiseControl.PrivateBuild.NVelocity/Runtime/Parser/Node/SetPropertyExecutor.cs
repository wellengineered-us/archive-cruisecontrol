...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Parser.Node
{
    ...
    public class SetPropertyExecutor : SetExecutor
    {
        ...
        /// <param name="arg">
        /// </param>
        public SetPropertyExecutor(Log.Log log, Introspector introspector, System.Type clazz, string property, object arg)
        {
            this.log = log;
        ...
        protected internal virtual void Discover(System.Type clazz, string property, object arg)
        {
            ...
            try
            {
                this.Method = (this.introspector.GetMethod(clazz, "set_" + property, parameters));
            }
            /**
        ...
        public override object Execute(object o, object value)
        {
            ...
            return this.Alive ? this.Method.Invoker.Invoke(o, (object[])params_Renamed) : null;
        }
    }
}
