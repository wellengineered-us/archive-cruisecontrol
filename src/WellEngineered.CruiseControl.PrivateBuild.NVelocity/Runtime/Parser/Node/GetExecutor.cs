...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Parser.Node
{
    ...
    public class GetExecutor : AbstractExecutor
    {
        ...
        /// <since> 1.5
        /// </since>
        public GetExecutor(Log.Log log, Introspector introspector, Type clazz, string property)
        {
            this.log = log;
        ...
        protected internal virtual void Discover(System.Type clazz)
        {
            try
            {
                this.Method = this.introspector.GetMethod(clazz, "get_Item", this.parameters);

                if (this.Method == null)
                {
                    this.Method = this.introspector.GetMethod(clazz, "Get", this.parameters);
                }
            }
            /**
            ...
            */
            ...
            catch (System.Exception e)
            {
                ...
                string msg = "Exception while looking for Get('" + this.parameters[0] + "') method";
        ...
        {
            return this.Alive ? this.Method.Invoker.Invoke(o, (object[])this.parameters) : null;
        }
    }
}