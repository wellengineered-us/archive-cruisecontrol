...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Parser.Node
{
    ...
    public class PutExecutor : SetExecutor
    {
        ...
        /// <param name="property">
        /// </param>
        public PutExecutor(Log.Log log, Introspector introspector, System.Type clazz, object arg, string property)
        {
            this.log = log;
        ...
        protected internal virtual void Discover(System.Type clazz, object arg)
        {
            ...
            {
                params_Renamed = new object[] { this.property, arg };
            }

            try
            {
                this.Method = this.introspector.GetMethod(clazz, "Put", params_Renamed);
            }
            /**
        ...
        /// <seealobjectutobjectlang.Object, java.lang.Object)">
        /// </seealso>
        public override object Execute(object o, object value)
        {
            ...
            if (this.Alive)
            {
                ...
                {
                    params_Renamed = new object[] { this.property, value };
                }

                return this.Method.Invoker.Invoke(o, (object[])params_Renamed);
            }
