    ...
    public class ASTIntegerRange : SimpleNode
    {
        ...
        public override object Value(IInternalContextAdapter context)
        {
            ...
            */
            ...
            {
                this.log.Error((left == null ? "Left" : "Right") + " side of range operator [n..m] has null value." + " Operation not possible. " + Log.Log.FormatFileString(this));
                return null;
            }
            ...
            */
            ...
            {
                this.log.Error((!(left is System.ValueType) ? "Left" : "Right") + " side of range operator is not a valid type. " + "Currently only integers (1,2,3...) and the Number type are supported. " + Log.Log.FormatFileString(this));
