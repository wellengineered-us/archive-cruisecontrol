...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Directive
{
    ...
    public class RuntimeMacro : Directive
    {
        ...
        private string Literal
        {
            get
            {
                if (this.literal == null)
                {
                    ...
                    Token t = this.node.FirstToken;

                    while (t != null && t != this.node.LastToken)
                    {
        ...
        public override bool Render(IInternalContextAdapter context, System.IO.TextWriter writer, INode node)
        {
            ...
            */
            object o = this.rsvc.GetVelocimacro(this.macroName, this.sourceTemplate, renderingTemplate);
            ...
            */
            if (vmProxy == null)
            {
                ...
                if (macroLibraries != null)
                {
                    ...
                    {
                        o = this.rsvc.GetVelocimacro(this.macroName, (string)macroLibraries[i], renderingTemplate);
            ...
            if (vmProxy != null)
            {
                ...
                {
                    Info info = new Info(this.sourceTemplate, node.Line, node.Column);
                ...
                {
                    this.rsvc.Log.Error("Exception in macro #" + this.macroName + " at " + Log.Log.FormatFileString(this.sourceTemplate, this.Line, this.Column));
                    throw e;
                }
            ...
            {
                Info info = new Info(this.sourceTemplate, node.Line, node.Column);
                throw new ParseErrorException("Macro '#" + this.macroName + "' is not defined at " + Log.Log.FormatFileString(info), info);
            }
