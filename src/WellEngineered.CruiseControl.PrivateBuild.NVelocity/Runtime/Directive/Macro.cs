...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Directive
{
    ...
    public class Macro : Directive
    {
        ...
        /// <seealso cref="Directive.Init(org.apache.velocity.runtime.RuntimeServices, org.apache.velocity.context.InternalContextAdapter, NVelocity.Runtime.Paser.Node.Node)">
        /// </seealso>
