    ...
    public class Evaluate : Directive
    {
        ...
        public override void Init(IRuntimeServices rs, IInternalContextAdapter context, INode node)
        {
            ...
            */
            ...
            if (argCount == 0)
            {
                throw new TemplateInitException("#" + this.Name + "() requires exactly one argument", context.CurrentTemplateName, node.Column, node.Line);
            }
            if (argCount > 1)
            {
                /* 
                ...
                */
                ...
                throw new TemplateInitException("#" + this.Name + "() requires exactly one argument", context.CurrentTemplateName, node.GetChild(1).Column, node.GetChild(1).Line);
            }
            ...
            {
                throw new TemplateInitException("#" + this.Name + "()  argument must be a string literal or reference", context.CurrentTemplateName, childNode.Column, childNode.Line);
            }
        }
        ...
        public override bool Render(IInternalContextAdapter context, System.IO.TextWriter writer, INode node)
        {
            ...
            */
            ...
            if (nodeTree != null)
            {
                IInternalContextAdapter ica = new EvaluateContext(context, this.rsvc);
