...
using WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Resource.Util;
    ...
    public class StringResourceLoader : ResourceLoader
    {
        ...
        public override void Init(ExtendedProperties configuration)
        {
            ...
            if (isStatic)
            {
                ...
                if (this.repository != null && this.log.DebugEnabled)
                {
            ...
            {
                this.repository = (IStringResourceRepository)this.rsvc.GetApplicationAttribute(repoName);
                if (this.repository != null && this.log.DebugEnabled)
                {
            ...
            if (this.repository == null)
            {
                ...
                this.repository = this.CceateRepository(repoClass, encoding);
            ...
            else
            {
                ...
                {
                    this.log.Debug("Cannot change class of string repository '" + repoName + "' from " + this.repository.GetType().FullName + " to " + repoClass + ". The change will be ignored.");
                }
                ...
                if (encoding != null && !this.repository.Encoding.Equals(encoding))
                {
                    ...
                    {
                        this.log.Debug("Changing the default encoding of string repository '" + repoName + "' from " + this.repository.Encoding + " to " + encoding);
                    }
        ...
        public virtual IStringResourceRepository CceateRepository(string className, string encoding)
        {
            ...
            if (this.log.DebugEnabled)
            {
                this.log.Debug("Default repository encoding is " + repo.Encoding);
            }
            return repo;
        }
        ...
        /// <seResourcerg.apache.velocity.runtime.resource.Resource)">
        /// </seealso>
        ...
        /// <sResourcerg.apache.velocity.runtime.resource.Resource)">
        /// </seealso>
