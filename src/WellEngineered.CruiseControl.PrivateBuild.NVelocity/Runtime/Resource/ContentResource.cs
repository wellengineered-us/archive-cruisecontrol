...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Runtime.Resource
{
    ...
    public class ContentResource : Resource
    {
            ...
            : base()
        {
            ...
            this.Type = NVelocity.Runtime.Resource.ResourceManagerConstants.RESOURCE_CONTENT;
        }
        ...
        public override bool Process()
        {
            ...
            try
            {
                ...
                reader = new StreamReader(
                     new StreamReader(
                         this.resourceLoader.GetResourceStream(this.name),
                         System.Text.Encoding.GetEncoding(this.encoding)).BaseStream);
