    ...
    public abstract class Resource
    {
        ...
        public virtual bool RequiresChecking()
        {
            ...
            */
            ...
            return ((DateTime.Now.Ticks - 621355968000000000) / 10000 >= this.nextCheck);
        }
        ...
        {
            this.nextCheck = (DateTime.Now.Ticks - 621355968000000000) / 10000 + (MILLIS_PER_SECOND * this.modificationCheckInterval);
        }
    }
}