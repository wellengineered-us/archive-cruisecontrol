    ...
    public class ResourceManagerImpl : IResourceManager
    {
        ...
        public virtual void Initialize(IRuntimeServices rsvc)
        {
            lock (syncOjb)
            {
                ...
                this.log.Trace("Default ResourceManager initializing. (" + this.GetType() + ")");

                this.AssembleResourceLoaderInitializers();


                for (IEnumerator it = this.sourceInitializerList.GetEnumerator(); it.MoveNext(); )
                {
                    /**
                ...
                */
                ...
                this.logWhenFound = rsvc.GetBoolean(NVelocity.Runtime.RuntimeConstants.RESOURCE_MANAGER_LOGWHENFOUND, true);
                ...
                */
                ...
                this.globalCache = (IResourceCache)cacheObject;
        ...
        {
            ArrayList resourceLoaderNames = this.rsvc.Configuration.GetVector(RuntimeConstants.RESOURCE_LOADER);
            ...
            for (IEnumerator it = resourceLoaderNames.GetEnumerator(); it.MoveNext(); )
            {
                ...
                */
                ...
                ExtendedProperties loaderConfiguration = this.rsvc.Configuration.Subset(loaderID.ToString());
            ...
            if (resource != null)
            {
                try
                {
                    ...
                    if (resource.RequiresChecking())
                    {
                        ...
                        */
                        resource = this.RefreshResource(resource, encoding);
                    }
                }
        ...
        protected internal virtual Resource LoadResource(string resourceName, int resourceType, string encoding)
        {
            ...
            */
            ...
            for (IEnumerator<ResourceLoader> it = this.resourceLoaders.GetEnumerator(); it.MoveNext(); )
            {
                ...
                try
                {
                    ...
                    if (resource.Process())
                    {
                        ...
                        */
                        ...
                        if (this.logWhenFound && this.log.DebugEnabled)
                        {
                            this.log.Debug("ResourceManager : found " + resourceName + " with loader " + resourceLoader.ClassName);
                        }
            ...
            */
            ...
            if (resource.IsSourceModified)
            {
                ...
                */
                ...
                {
                    this.log.Warn("Declared encoding for template '" + resource.Name + "' is different on reload. Old = '" + resource.Encoding + "' New = '" + encoding);
                ...
                */
                ...
                newResource.RuntimeServices = this.rsvc;
