...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.App
{
	/// <summary> <p>
    ...
    public class VelocityEngine
    {
        ...
        {
            return this.ri.Evaluate(context, writer, logTag, instring);
        }
        ...
        {
            return this.ri.InvokeVelocimacro(vmName, logTag, parameters, context, writer);
        }
