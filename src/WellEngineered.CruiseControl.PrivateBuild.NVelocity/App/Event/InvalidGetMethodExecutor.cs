...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.App.Event
{
    ...
    class InvalidGetMethodExecutor : IEventHandlerMethodExecutor
    {
        ...
        {
            this.result = ((IInvalidReferenceEventHandler)handler).InvalidGetMethod(this.context, this.reference, this.object_Renamed, this.property, this.info);
        }
    }
    /// <summary> Defines the execution strategy for InvalidGetMethod</summary>
    class InvalidSetMethodExecutor : IEventHandlerMethodExecutor
    {
        ...
        public virtual void Execute(IEventHandler handler)
        {
            this.result = ((IInvalidReferenceEventHandler)handler).InvalidSetMethod(this.context, this.leftreference, this.rightreference, this.info);
        }
    }
    /// <summary> Defines the execution strategy for InvalidGetMethod</summary>
    class InvalidMethodExecutor : IEventHandlerMethodExecutor
    {
        ...
        {
            this.executed = true;
            this.result = ((IInvalidReferenceEventHandler)handler).InvalidMethod(this.context, this.reference, this.object_Renamed, this.method, this.info);
        }
    }
