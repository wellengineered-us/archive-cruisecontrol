    ...
    public class EvaluateContext : ChainedInternalContextAdapter
    {
        ...
        override public object[] Keys
        {
            get
            {
                ...
                object[] localKeys = this.localContext.Keys;
        ...
        override public bool AllowRendering
        {
            get
            {
                return this.allowRendering && this.innerContext.AllowRendering;
            }
        ...
        {
            return this.localContext.ContainsKey(key) || base.ContainsKey(key);
        }
