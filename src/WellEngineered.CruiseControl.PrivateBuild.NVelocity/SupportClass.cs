...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity
{
	/// <summary>
    /// 
    /// </summary>
    public class SupportClass
    {
        ...
        public class StringEscapeUtils
        {
            ...
            /// <returns> a new escaped <code>String</code>, <code>null</code> if null string input
            /// </returns>
            /// <seealso cref="unescapeXml(string)">
            /// </seealso>
        ...
        class IntHashMap
        {
                ...
                : base()
            {
                ...
                //UPGRADE_WARNING: �� Visual C# �У��������Ϳ��ܲ�ͬ������֤����ת������ȷ�ԡ� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1042'"
            ...
            //UPGRADE_NOTE: Synchronized �ؼ����Ѵӷ�����clear�����Ƴ���������������ʽ�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1027'"
        ...
        class Entities
        {
            ...
            //UPGRADE_NOTE: Final �Ѵӡ�BASIC_ARRAY�����������Ƴ��� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
            ...
            //UPGRADE_NOTE: Final �Ѵӡ�APOS_ARRAY�����������Ƴ��� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
            private static readonly string[][] APOS_ARRAY = new string[][] { new string[] { "apos", "39" } };

            // package scoped for testing
            //UPGRADE_NOTE: Final �Ѵӡ�ISO8859_1_ARRAY�����������Ƴ��� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
            ...
            // package scoped for testing
            //UPGRADE_NOTE: Final �Ѵӡ�HTML40_ARRAY�����������Ƴ��� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
            ...
            internal class PrimitiveEntityMap : Entities.EntityMap
            {
                ...
                {
                    this.mapNameToValue[name] = (System.Int32)value;
                ...
                {
                    return (string)this.mapValueToName.get_Renamed(value);
                }

                /// <summary> {@inheritDoc}</summary>
                public virtual int value(string name)
                {
                    object value = this.mapNameToValue[name];
                    if (value == null)
                    {
                        return -1;
                    }
            ...
            internal abstract class MapIntMap : Entities.EntityMap
            {
                ...
                {
                    this.mapNameToValue[name] = (System.Int32)value;
                    this.mapValueToName[(System.Int32)value] = name;
                }

                /// <summary> {@inheritDoc}</summary>
                public virtual string name(int value)
                {
                    return (string)this.mapValueToName[(System.Int32)value];
                }
            ...
            internal class HashEntityMap : MapIntMap
            {
                ...
                {
                    //UPGRADE_TODO: Class��java.util.HashMap����ת��Ϊ���в�ͬ��Ϊ�� 'System.Collections.Hashtable'�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javautilHashMap'"
                    this.mapNameToValue = new System.Collections.Hashtable();
                    //UPGRADE_TODO: Class��java.util.HashMap����ת��Ϊ���в�ͬ��Ϊ�� 'System.Collections.Hashtable'�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javautilHashMap'"
                    this.mapValueToName = new System.Collections.Hashtable();
                }
            }
            ...
            internal class TreeEntityMap : MapIntMap
            {
                ...
                {
                    //UPGRADE_TODO: ���캯����java.util.TreeMap.TreeMap����ת��Ϊ���в�ͬ��Ϊ�� 'System.Collections.SortedList'�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javautilTreeMapTreeMap'"
                    //UPGRADE_ISSUE: ��java.util.TreeMap���͡�System.Collections.SortedList��֮������νṹ������ܵ��±������ "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1186'"
                    this.mapNameToValue = new System.Collections.SortedList();
                    //UPGRADE_TODO: ���캯����java.util.TreeMap.TreeMap����ת��Ϊ���в�ͬ��Ϊ�� 'System.Collections.SortedList'�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javautilTreeMapTreeMap'"
                    //UPGRADE_ISSUE: ��java.util.TreeMap���͡�System.Collections.SortedList��֮������νṹ������ܵ��±������ "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1186'"
                    this.mapValueToName = new System.Collections.SortedList();
                }
            }
            ...
            internal class LookupEntityMap : PrimitiveEntityMap
            {
                ...
                {
                    if (this.lookupTable_Renamed_Field == null)
                    {
                        this.createLookupTable();
                    }
                    return this.lookupTable_Renamed_Field;
                }
                ...
                {
                    this.lookupTable_Renamed_Field = new string[this.LOOKUP_TABLE_SIZE];
                    for (int i = 0; i < this.LOOKUP_TABLE_SIZE; ++i)
                    {
                        this.lookupTable_Renamed_Field[i] = base.name(i);
                    }
                }
            }
            ...
            internal class ArrayEntityMap : Entities.EntityMap
            {
                ...
                protected internal virtual void ensureCapacity(int capacity)
                {
                    ...
                    {
                        int newSize = System.Math.Max(capacity, this.size + this.growBy);
                        string[] newNames = new string[newSize];
                        Array.Copy(this.names, 0, newNames, 0, this.size);
                        this.names = newNames;
            ...
            internal class BinaryEntityMap : ArrayEntityMap
            {
                ...
                public override void add(string name, int value)
                {
                    ...
                    Array.Copy(this.values, insertAt, this.values, insertAt + 1, this.size - insertAt);
                    this.values[insertAt] = value;
                    Array.Copy(this.names, insertAt, this.names, insertAt + 1, this.size - insertAt);
            ...
            public virtual void addEntities(string[][] entityArray)
            {
                ...
                {
                    this.addEntity(entityArray[i][0], System.Int32.Parse(entityArray[i][1]));
                }
            }
            ...
            {
                System.IO.StringWriter stringWriter = this.createStringWriter(str);
                try
                {
            ...
            /// <seealso cref="Writer">
            /// </seealso>
            //UPGRADE_ISSUE: ��java.io.Writer���͡�System.IO.StreamWriter��֮������νṹ������ܵ��±������ "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1186'"
            ...
            private void doUnescape(System.IO.TextWriter writer, string str, int firstAmp)
            {
                ...
                for (int i = firstAmp; i < len; i++)
                {
                    ...
                    {
                        int nextIdx = i + 1;
                        //UPGRADE_WARNING: ���� 'java.lang.String.indexOf' ��ת��Ϊ 'string.IndexOf'�����߿��������쳣�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1101'"
                                ...
                                if (entityContentLen > 1)
                                {
                                    ...
                                    try
                                    {
                                        switch (isHexChar)
                                        {
                                            ...
                                            case 'x':
                                                {
                                                    //UPGRADE_TODO: ������java.lang.Integer.parseInt����ת��Ϊ���в�ͬ��Ϊ�� 'System.Convert.ToInt32'�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073'"
        ...
        public class StringUtils
        {
            ...
            private static string padding(int repeat, char padChar)
            {
                ...
                //UPGRADE_NOTE: Final �Ѵӡ�buf �����������Ƴ��� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
