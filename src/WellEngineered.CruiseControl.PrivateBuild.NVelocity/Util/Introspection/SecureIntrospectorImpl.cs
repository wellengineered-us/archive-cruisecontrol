    ...
    public class SecureIntrospectorImpl : Introspector, ISecureIntrospectorControl
    {
        ...
        public override MethodEntry GetMethod(System.Type clazz, string methodName, object[] params_Renamed)
        {
            if (!this.CheckObjectExecutePermission(clazz, methodName))
            {
                ...
                this.log.Warn("Cannot retrieve method " + methodName + " from object of class " + clazz.FullName + " due to security restrictions.");
                return null;
            }
            else
            {
        ...
        /// <param name="methodName">Name of method to be called
        /// </param>
        /// <seealso cref="org.apache.velocity.util.introspection.SecureIntrospectorControl.CheckObjectExecutePermission(java.lang.Class, string)">
        /// </seealso>
        public virtual bool CheckObjectExecutePermission(System.Type clazz, string methodName)
        {
            ...
            */
            ...
            for (int i = 0, size = this.badPackages.Length; i < size; i++)
            {
            ...
            for (int i = 0, size = this.badClasses.Length; i < size; i++)
            {
