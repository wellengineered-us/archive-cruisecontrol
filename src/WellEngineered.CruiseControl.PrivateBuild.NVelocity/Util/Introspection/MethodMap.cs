...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity.Util.Introspection
{
    ...
    public class MethodMap
    {
        ...
        public virtual void add(System.Reflection.MethodInfo method)
        {
            ...
            System.Collections.IList l = this.get_Renamed(methodName);

            if (l == null)
            {
                l = new System.Collections.ArrayList();
                this.methodByNameMap[methodName] = l;
            }
        ...
        {
            return (System.Collections.IList)this.methodByNameMap[key];
        }
        ...
        {
            System.Collections.IList methodList = this.get_Renamed(methodName);
        ...
        private static System.Reflection.MethodInfo getBestMatch(System.Collections.IList methods, System.Type[] args)
        {
            ...
            //UPGRADE_TODO: ������java.util.Iterator.hasNext����ת��Ϊ���в�ͬ��Ϊ�� 'System.Collections.IEnumerator.MoveNext'�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javautilIteratorhasNext'"
            for (System.Collections.IEnumerator i = methods.GetEnumerator(); i.MoveNext(); )
            {
                //UPGRADE_TODO: ������java.util.Iterator.next����ת��Ϊ���в�ͬ��Ϊ�� 'System.Collections.IEnumerator.Current'�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javautilIteratornext'"
                ...
                if (isApplicable(method, args))
                {
                    ...
                    {
                        bestMatch = method;
                        //UPGRADE_TODO: �� .NET �У�������java.lang.reflect.Method.getParameterTypes���ĵ�Ч����ܷ��ز�ͬ��ֵ�� "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
