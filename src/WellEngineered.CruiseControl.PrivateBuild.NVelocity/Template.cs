...
namespace WellEngineered.CruiseControl.PrivateBuild.NVelocity
{
    ...
    public class Template : Resource
    {
            ...
            : base()
        {
            ...
            this.Type = ResourceManagerConstants.RESOURCE_TEMPLATE;
        }
        ...
        public override bool Process()
        {
            ...
            */
            try
            {
                stream = this.resourceLoader.GetResourceStream(this.name);
            }
            ...
            */
            ...
            if (stream != null)
            {
                ...
                */
                ...
                try
                {
                    using (StreamReader br = new StreamReader(stream, System.Text.Encoding.GetEncoding(this.encoding)))
                    {
                ...
                */
                ...
                {
                    throw new RuntimeException("Exception thrown processing Template " + this.Name, e);
                }
                finally
                {
                    /*
                ...
                if (macroLibraries != null)
                {
                    for (int i = 0; i < macroLibraries.Count; i++)
                    {
                        ...
                        */
                        try
                        {
                            this.rsvc.GetTemplate((string)macroLibraries[i]);
                        }
                        catch (ResourceNotFoundException re)
                        {
                            ...
                            */
                            this.rsvc.Log.Error("template.merge(): " + "cannot find template " + ((string)macroLibraries[i]));
                            throw re;
                        }
                        catch (ParseErrorException pe)
                        {
                            ...
                            *  note it and throw
                            */
                            this.rsvc.Log.Error("template.merge(): " + "syntax error in template " + ((string)macroLibraries[i]) + ".");
                            throw pe;
                        }
