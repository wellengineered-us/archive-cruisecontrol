...
namespace WellEngineered.CruiseControl.PrivateBuild.NetReflector
{
	public class NetReflectorWriter
	{
		...
		public void Write(object target)
		{
			...
			attribute.Write(this.writer, target);
		}
	}
	...
	public class NetReflectorReader
	{
		...
		public void Read(XmlNode node, object instance)
		{
			...
			new XmlTypeSerialiser(instance.GetType(), new ReflectorTypeAttribute(instance.GetType().Name)).ReadMembers(node, instance, this.table);
		}
	}
